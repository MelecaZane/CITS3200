...
def initialise_leapmotion_with_callback(hz: int, callback_func=None):
    """
    Enhanced version of initialise_leapmotion that calls a callback when ready to start tracking.
    """
    hand_data = {}
    # Each hand has these digits, each digit having each of thes bones
    digits = ["thumb", "index", "middle", "ring", "pinky"]
